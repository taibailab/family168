...
<%
    ...
    pageContext.setAttribute("totalCount", Long.valueOf(2000L));
    pageContext.setAttribute("pageSize", 50);
...
<html>
    ...
    <body>
        ...
        <pager:pager longTotalCount="${totalCount}" pageSize="${pageSize}" params="${params}">
